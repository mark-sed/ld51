...
public class FuelForMoney extends Offer {
	...
	public FuelForMoney(Seller seller) {
		this.seller = seller;
		this.fuel = r.nextInt(15)+1;
		this.price = this.fuel*2;
		if(seller.getID() != BlackMarket.UID) {
			if(this.fuel > 8 && Game.player.getTradingIndex() > -0.5f) {
